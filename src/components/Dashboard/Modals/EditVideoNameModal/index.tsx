    ...
    <>
      <button
        ...
        className="w-full inline-flex justify-center rounded-md border 
                  ...
                  text-white hover:bg-p-blue-dark focus:outline-none focus:ring-2 focus:ring-offset-2 
                  focus:ring-p-blue-dark sm:ml-3 sm:w-auto sm:text-sm"
      >
        Editar
      </button>
